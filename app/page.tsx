  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative min-h-[95vh] flex flex-col items-center justify-center text-center px-6 pt-12">
        ...
        >
          <div className="w-full h-full bg-[radial-gradient(circle_at_center,_#D4AF37_20%,_black_70%)] opacity-20"></div>
        </motion.div>
        ...
        >
          ...
          <h1 className="text-4xl md:text-7xl font-black mb-6 tracking-tight leading-tight font-serif-imperial">
            LUAN HÉRCULES <br />
